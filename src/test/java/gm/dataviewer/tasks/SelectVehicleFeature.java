...
public class SelectVehicleFeature implements Task {
    ...
    private SelectVehicleFeature(String year, String division, String brand, String category, String status) {
        this.year = year;
    ...
    static public SelectVehicleFeature feature(String year, String division, String brand, String category, String status) {
        return new SelectVehicleFeature(year, division, brand, category, status);
    }
