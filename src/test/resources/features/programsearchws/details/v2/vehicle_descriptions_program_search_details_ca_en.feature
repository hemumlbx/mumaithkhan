@CanadaOnly @TEST:GMIOMSUS-57570
Feature: Program Search WS Details - V2 Vehicles Published through different tabs using Data Viewer in Canada EN

  Background:
    Given John has access to the search api at V2 in CA

  @TEST:GMIOMSUS-57554
  Scenario Outline: Program Search WS - Details - V2 Search By Features Descriptions Added through Search Tab in Data Viewer CA EN
  ...
  @TEST:GMIOMSUS-57555
  Scenario Outline: Program Search WS - Details - V2 Search By RPO Descriptions using Single Edit in Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57556
  Scenario Outline: Program Search WS - Details - V2 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57557
  Scenario Outline: Program Search WS - Details - V2 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57558
  Scenario Outline: Program Search WS - Details - V2 Edited Nameplate published through Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57559
  Scenario Outline: Program Search WS - Details - V2 New Nameplate published through Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57560
  Scenario Outline: Program Search WS - Details - V2 Edited Brand published through Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-57561
  Scenario Outline: Program Search WS - Details - V2 Added Brand published through Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @issue:GMIOMSUS-57220 @TEST:GMIOMSUS-57562
  Scenario Outline: Program Search WS - Details - V2 Edited Features published through Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57563
  Scenario Outline: Program Search WS - Details - V2 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57564
  Scenario Outline: Program Search WS - Details - V2 Added RPO - Single RPO - 1 published through Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57565
  Scenario Outline: Program Search WS - Details - V2 Edit Multiple RPOs 1 published through Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57566
  Scenario Outline: Program Search WS - Details - V2 Edit Multiple RPOs 2 published through Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57567
  Scenario Outline: Program Search WS - Details - V2 Added RPO - Single RPO - 2 published through Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57568
  Scenario Outline: Program Search WS - Details - V2 Edit Category published through Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57569
  Scenario Outline: Program Search WS - Details - V2 New Category published through Data Viewer CA EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
