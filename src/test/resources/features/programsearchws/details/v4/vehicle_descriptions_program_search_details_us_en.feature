@USOnly @TEST:GMIOMSUS-57706
Feature: Program Search WS Details - V4 Vehicles Published through different tabs using Data Viewer in US EN

  Background:
    Given John has access to the search api at V4 in US

  @TEST:GMIOMSUS-57690
  Scenario Outline: Program Search WS - Details - V4 Search By Features Descriptions Added through Search Tab in Data Viewer US EN
  ...
  @TEST:GMIOMSUS-57691
  Scenario Outline: Program Search WS - Details - V4 Search By RPO Descriptions using Single Edit in Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57692
  Scenario Outline: Program Search WS - Details - V4 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57693
  Scenario Outline: Program Search WS - Details - V4 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57694
  Scenario Outline: Program Search WS - Details - V4 Edited Nameplate published through Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57695
  Scenario Outline: Program Search WS - Details - V4 New Nameplate published through Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57696
  Scenario Outline: Program Search WS - Details - V4 Edited Brand published through Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @issue:GMIOMSUS-53727   @TEST:GMIOMSUS-57697
  Scenario Outline: Program Search WS - Details - V4 Added Brand published through Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @issue:GMIOMSUS-57220   @TEST:GMIOMSUS-57698
  Scenario Outline: Program Search WS - Details - V4 Edited Features published through Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57699
  Scenario Outline: Program Search WS - Details - V4 Edit RPO Tab - Single RPO - 1 published through Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57700
  Scenario Outline: Program Search WS - Details - V4 Added RPO - Single RPO - 1 published through Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57701
  Scenario Outline: Program Search WS - Details - V4 Edit Multiple RPOs 1 published through Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57702
  Scenario Outline: Program Search WS - Details - V4 Edit Multiple RPOs 2 published through Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57703
  Scenario Outline: Program Search WS - Details - V4 Added RPO - Single RPO - 2 published through Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57704
  Scenario Outline: Program Search WS - Details - V4 Edit Category published through Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57705
  Scenario Outline: Program Search WS - Details - V4 New Category published through Data Viewer US EN
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | EN       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
