@CanadaOnly @TEST:GMIOMSUS-57689
Feature: Program Search WS Details - V4 Vehicles Published through different tabs using Data Viewer in Canada FR

  Background:
    Given John has access to the search api at V4 in CA

  @TEST:GMIOMSUS-57673
  Scenario Outline: Program Search WS - Details - V4 Search By Features Descriptions Added through Search Tab in Data Viewer CA FR
  ...
  @TEST:GMIOMSUS-57674
  Scenario Outline: Program Search WS - Details - V4 Search By RPO Descriptions using Single Edit in Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57675
  Scenario Outline: Program Search WS - Details - V4 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57676
  Scenario Outline: Program Search WS - Details - V4 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57677
  Scenario Outline: Program Search WS - Details - V4 Edited Nameplate published through Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57678
  Scenario Outline: Program Search WS - Details - V4 New Nameplate published through Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57679
  Scenario Outline: Program Search WS - Details - V4 Edited Brand published through Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-57680
  Scenario Outline: Program Search WS - Details - V4 Added Brand published through Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @issue:GMIOMSUS-57220 @TEST:GMIOMSUS-57681
  Scenario Outline: Program Search WS - Details - V4 Edited Features published through Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57682
  Scenario Outline: Program Search WS - Details - V4 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57683
  Scenario Outline: Program Search WS - Details - V4 Added RPO - Single RPO - 1 published through Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57684
  Scenario Outline: Program Search WS - Details - V4 Edit Multiple RPOs 1 published through Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57685
  Scenario Outline: Program Search WS - Details - V4 Edit Multiple RPOs 2 published through Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57686
  Scenario Outline: Program Search WS - Details - V4 Added RPO - Single RPO - 2 published through Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57687
  Scenario Outline: Program Search WS - Details - V4 Edit Category published through Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
  ...
  @TEST:GMIOMSUS-57688
  Scenario Outline: Program Search WS - Details - V4 New Category published through Data Viewer CA FR
    When he submits a get Incentive Program Details request
      | requestProgramID   | requestRevisionNumber   | language |
      | <requestprogramID> | <requestrevisionNumber> | FR       |
    Then he should see vehicle incentive list along with filters '<vehicleFilterString>' with description '<vehicleDescription>' and change indicator '<vehicleChangeInd>' in the response
