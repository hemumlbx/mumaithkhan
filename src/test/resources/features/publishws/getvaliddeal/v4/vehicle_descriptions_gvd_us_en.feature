@USOnly @TEST:GMIOMSUS-58080
Feature: Publish WS GVD - V4 Vehicles Published through different tabs using Data Viewer in US EN

  Background:
    Given John has access to the vehicle api for country US using V4

  @TEST:GMIOMSUS-58065
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Search By Features Descriptions Added through Search Tab in Data Viewer US EN
  ...
  @TEST:GMIOMSUS-58066
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Search By RPO Descriptions using Single Edit in Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58067
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58068
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58069
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Edited Nameplate published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58070
  Scenario Outline: Publish WS  - Get Valid Deal - V4 New Nameplate published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58071
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Edited Brand published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58072
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Added Brand published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58073
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Edited Features published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58074
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Edit RPO Tab - Single RPO - 1 published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58075
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Added RPO - Single RPO - 1 published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58076
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Edit Multiple RPOs 1 published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58077
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Added RPO - Single RPO - 2 published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58078
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Edit Category published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58079
  Scenario Outline: Publish WS  - Get Valid Deal - V4 New Category published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
