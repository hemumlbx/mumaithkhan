@CanadaOnly @TEST:GMIOMSUS-58048
Feature: Publish WS GVD - V4 Vehicles Published through different tabs using Data Viewer in Canada EN

  Background:
    Given John has access to the vehicle api for country CA using V4

  @TEST:GMIOMSUS-58033
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Search By Features Descriptions Added through Search Tab in Data Viewer CA EN
  ...
  @TEST:GMIOMSUS-58034
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Search By RPO Descriptions using Single Edit in Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58035
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58036
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58037
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Edited Nameplate published through Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58038
  Scenario Outline: Publish WS  - Get Valid Deal - V4 New Nameplate published through Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58039
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Edited Brand published through Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58040
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Added Brand published through Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58041
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Edited Features published through Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58042
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58043
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Added RPO - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58044
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Edit Multiple RPOs 1 published through Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58045
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Added RPO - Single RPO - 2 published through Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58046
  Scenario Outline: Publish WS  - Get Valid Deal - V4 Edit Category published through Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58047
  Scenario Outline: Publish WS  - Get Valid Deal - V4 New Category published through Data Viewer CA EN
    When the user has a GVD vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
