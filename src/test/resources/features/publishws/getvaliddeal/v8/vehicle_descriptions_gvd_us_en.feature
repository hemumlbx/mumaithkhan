@USOnly @TEST:GMIOMSUS-58272
Feature: Publish WS GVD - V8 Vehicles Published through different tabs using Data Viewer in US EN

  Background:
    Given John has access to the vehicle api for country US using V8

  @TEST:GMIOMSUS-58257
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Search By Features Descriptions Added through Search Tab in Data Viewer US EN
  ...
  @TEST:GMIOMSUS-58258
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Search By RPO Descriptions using Single Edit in Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58259
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58260
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58261
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Edited Nameplate published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58262
  Scenario Outline: Publish WS  - Get Valid Deal - V8 New Nameplate published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58263
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Edited Brand published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58264
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Added Brand published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58265
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Edited Features published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58266
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Edit RPO Tab - Single RPO - 1 published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58267
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Added RPO - Single RPO - 1 published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58268
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Edit Multiple RPOs 1 published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58269
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Added RPO - Single RPO - 2 published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58270
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Edit Category published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58271
  Scenario Outline: Publish WS  - Get Valid Deal - V8 New Category published through Data Viewer US EN
    When the user has a GVD vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
