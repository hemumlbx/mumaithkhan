@CanadaOnly @TEST:GMIOMSUS-58256
Feature: Publish WS GVD - V8 Vehicles Published through different tabs using Data Viewer in Canada FR

  Background:
    Given John has access to the vehicle api for country CA using V8

  @TEST:GMIOMSUS-58241
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Search By Features Descriptions Added through Search Tab in Data Viewer CA FR
  ...
  @TEST:GMIOMSUS-58242
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Search By RPO Descriptions using Single Edit in Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58243
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58244
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58245
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Edited Nameplate published through Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58246
  Scenario Outline: Publish WS  - Get Valid Deal - V8 New Nameplate published through Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58247
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Edited Brand published through Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58248
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Added Brand published through Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58249
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Edited Features published through Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58250
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58251
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Added RPO - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58252
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Edit Multiple RPOs 1 published through Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58253
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Added RPO - Single RPO - 2 published through Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58254
  Scenario Outline: Publish WS  - Get Valid Deal - V8 Edit Category published through Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
  ...
  @TEST:GMIOMSUS-58255
  Scenario Outline: Publish WS  - Get Valid Deal - V8 New Category published through Data Viewer CA FR
    When the user has a GVD vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GVD vehicle
