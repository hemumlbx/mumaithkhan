@CanadaOnly @TEST:GMIOMSUS-58304
Feature: Publish WS GVM - V4 Vehicles Published through different tabs using Data Viewer in Canada FR

  Background:
    Given John has access to the vehicle api for country CA using V4

  @TEST:GMIOMSUS-58289
  Scenario Outline: Publish WS  - GVM - V4 Search By Features Descriptions Added through Search Tab in Data Viewer CA FR
  ...
  @TEST:GMIOMSUS-58290
  Scenario Outline: Publish WS  - GVM - V4 Search By RPO Descriptions using Single Edit in Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58291
  Scenario Outline: Publish WS  - GVM - V4 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58292
  Scenario Outline: Publish WS  - GVM - V4 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58293
  Scenario Outline: Publish WS  - GVM - V4 Edited Nameplate published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58294
  Scenario Outline: Publish WS  - GVM - V4 New Nameplate published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58295
  Scenario Outline: Publish WS  - GVM - V4 Edited Brand published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58296
  Scenario Outline: Publish WS  - GVM - V4 Added Brand published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @issue:GMIOMSUS-57220 @TEST:GMIOMSUS-58297
  Scenario Outline: Publish WS  - GVM - V4 Edited Features published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58298
  Scenario Outline: Publish WS  - GVM - V4 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58299
  Scenario Outline: Publish WS  - GVM - V4 Added RPO - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58300
  Scenario Outline: Publish WS  - GVM - V4 Edit Multiple RPOs 1 published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58301
  Scenario Outline: Publish WS  - GVM - V4 Added RPO - Single RPO - 2 published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58302
  Scenario Outline: Publish WS  - GVM - V4 Edit Category published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58303
  Scenario Outline: Publish WS  - GVM - V4 New Category published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
