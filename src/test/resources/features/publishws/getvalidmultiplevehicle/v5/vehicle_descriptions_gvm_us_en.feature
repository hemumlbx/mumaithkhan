@USOnly @TEST:GMIOMSUS-58368
Feature: Publish WS GVM - V5 Vehicles Published through different tabs using Data Viewer in US EN

  Background:
    Given John has access to the vehicle api for country US using V5

  @TEST:GMIOMSUS-58353
  Scenario Outline: Publish WS  - GVM - V5 Search By Features Descriptions Added through Search Tab in Data Viewer US EN
  ...
  @TEST:GMIOMSUS-58354
  Scenario Outline: Publish WS  - GVM - V5 Search By RPO Descriptions using Single Edit in Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58355
  Scenario Outline: Publish WS  - GVM - V5 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58356
  Scenario Outline: Publish WS  - GVM - V5 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58357
  Scenario Outline: Publish WS  - GVM - V5 Edited Nameplate published through Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58358
  Scenario Outline: Publish WS  - GVM - V5 New Nameplate published through Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58359
  Scenario Outline: Publish WS  - GVM - V5 Edited Brand published through Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58360
  Scenario Outline: Publish WS  - GVM - V5 Added Brand published through Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58361
  Scenario Outline: Publish WS  - GVM - V5 Edited Features published through Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58362
  Scenario Outline: Publish WS  - GVM - V5 Edit RPO Tab - Single RPO - 1 published through Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58363
  Scenario Outline: Publish WS  - GVM - V5 Added RPO - Single RPO - 1 published through Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58364
  Scenario Outline: Publish WS  - GVM - V5 Edit Multiple RPOs 1 published through Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58365
  Scenario Outline: Publish WS  - GVM - V5 Added RPO - Single RPO - 2 published through Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58366
  Scenario Outline: Publish WS  - GVM - V5 Edit Category published through Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58367
  Scenario Outline: Publish WS  - GVM - V5 New Category published through Data Viewer US EN
    When the user has a GMV vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
