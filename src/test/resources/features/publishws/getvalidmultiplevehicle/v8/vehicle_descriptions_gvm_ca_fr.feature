@CanadaOnly @TEST:GMIOMSUS-58496
Feature: Publish WS GVM - V8 Vehicles Published through different tabs using Data Viewer in Canada FR

  Background:
    Given John has access to the vehicle api for country CA using V8

  @TEST:GMIOMSUS-58481
  Scenario Outline: Publish WS  - GVM - V8 Search By Features Descriptions Added through Search Tab in Data Viewer CA FR
  ...
  @TEST:GMIOMSUS-58482
  Scenario Outline: Publish WS  - GVM - V8 Search By RPO Descriptions using Single Edit in Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58483
  Scenario Outline: Publish WS  - GVM - V8 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58484
  Scenario Outline: Publish WS  - GVM - V8 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58485
  Scenario Outline: Publish WS  - GVM - V8 Edited Nameplate published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58486
  Scenario Outline: Publish WS  - GVM - V8 New Nameplate published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58487
  Scenario Outline: Publish WS  - GVM - V8 Edited Brand published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58488
  Scenario Outline: Publish WS  - GVM - V8 Added Brand published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @issue:GMIOMSUS-57220 @TEST:GMIOMSUS-58489
  Scenario Outline: Publish WS  - GVM - V8 Edited Features published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58490
  Scenario Outline: Publish WS  - GVM - V8 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58491
  Scenario Outline: Publish WS  - GVM - V8 Added RPO - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58492
  Scenario Outline: Publish WS  - GVM - V8 Edit Multiple RPOs 1 published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58493
  Scenario Outline: Publish WS  - GVM - V8 Added RPO - Single RPO - 2 published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58494
  Scenario Outline: Publish WS  - GVM - V8 Edit Category published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58495
  Scenario Outline: Publish WS  - GVM - V8 New Category published through Data Viewer CA FR
    When the user has a GMV vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
