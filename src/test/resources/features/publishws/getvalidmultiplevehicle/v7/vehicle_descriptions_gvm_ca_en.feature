@CanadaOnly @TEST:GMIOMSUS-58432
Feature: Publish WS GVM - V7 Vehicles Published through different tabs using Data Viewer in Canada EN

  Background:
    Given John has access to the vehicle api for country CA using V7

  @TEST:GMIOMSUS-58417
  Scenario Outline: Publish WS  - GVM - V7 Search By Features Descriptions Added through Search Tab in Data Viewer CA EN
  ...
  @TEST:GMIOMSUS-58418
  Scenario Outline: Publish WS  - GVM - V7 Search By RPO Descriptions using Single Edit in Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58419
  Scenario Outline: Publish WS  - GVM - V7 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58420
  Scenario Outline: Publish WS  - GVM - V7 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58421
  Scenario Outline: Publish WS  - GVM - V7 Edited Nameplate published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58422
  Scenario Outline: Publish WS  - GVM - V7 New Nameplate published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58423
  Scenario Outline: Publish WS  - GVM - V7 Edited Brand published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58424
  Scenario Outline: Publish WS  - GVM - V7 Added Brand published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @issue:GMIOMSUS-57220 @TEST:GMIOMSUS-58425
  Scenario Outline: Publish WS  - GVM - V7 Edited Features published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58426
  Scenario Outline: Publish WS  - GVM - V7 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58427
  Scenario Outline: Publish WS  - GVM - V7 Added RPO - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58428
  Scenario Outline: Publish WS  - GVM - V7 Edit Multiple RPOs 1 published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58429
  Scenario Outline: Publish WS  - GVM - V7 Added RPO - Single RPO - 2 published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58430
  Scenario Outline: Publish WS  - GVM - V7 Edit Category published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58431
  Scenario Outline: Publish WS  - GVM - V7 New Category published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
