@CanadaOnly @TEST:GMIOMSUS-58384
Feature: Publish WS GVM - V6 Vehicles Published through different tabs using Data Viewer in Canada EN

  Background:
    Given John has access to the vehicle api for country CA using V6

  @TEST:GMIOMSUS-58369
  Scenario Outline: Publish WS  - GVM - V6 Search By Features Descriptions Added through Search Tab in Data Viewer CA EN
  ...
  @TEST:GMIOMSUS-58370
  Scenario Outline: Publish WS  - GVM - V6 Search By RPO Descriptions using Single Edit in Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58371
  Scenario Outline: Publish WS  - GVM - V6 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58372
  Scenario Outline: Publish WS  - GVM - V6 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58373
  Scenario Outline: Publish WS  - GVM - V6 Edited Nameplate published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58374
  Scenario Outline: Publish WS  - GVM - V6 New Nameplate published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58375
  Scenario Outline: Publish WS  - GVM - V6 Edited Brand published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58376
  Scenario Outline: Publish WS  - GVM - V6 Added Brand published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @issue:GMIOMSUS-57220 @TEST:GMIOMSUS-58377
  Scenario Outline: Publish WS  - GVM - V6 Edited Features published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58378
  Scenario Outline: Publish WS  - GVM - V6 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58379
  Scenario Outline: Publish WS  - GVM - V6 Added RPO - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58380
  Scenario Outline: Publish WS  - GVM - V6 Edit Multiple RPOs 1 published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58381
  Scenario Outline: Publish WS  - GVM - V6 Added RPO - Single RPO - 2 published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58382
  Scenario Outline: Publish WS  - GVM - V6 Edit Category published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
  ...
  @TEST:GMIOMSUS-58383
  Scenario Outline: Publish WS  - GVM - V6 New Category published through Data Viewer CA EN
    When the user has a GMV vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a request for GMV vehicle
