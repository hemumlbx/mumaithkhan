@CanadaOnly @TEST:GMIOMSUS-58880
Feature: Publish WS GVDP - V6 Vehicles Published through different tabs using Data Viewer in Canada FR

  Background:
    Given John has access to the vehicle api for country CA using V6

  @TEST:GMIOMSUS-58865
  Scenario Outline: Publish WS  - GVDP - V6 Search By Features Descriptions Added through Search Tab in Data Viewer CA FR
  ...
  @TEST:GMIOMSUS-58866
  Scenario Outline: Publish WS  - GVDP - V6 Search By RPO Descriptions using Single Edit in Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58867
  Scenario Outline: Publish WS  - GVDP - V6 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58868
  Scenario Outline: Publish WS  - GVDP - V6 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58869
  Scenario Outline: Publish WS  - GVDP - V6 Edited Nameplate published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58870
  Scenario Outline: Publish WS  - GVDP - V6 New Nameplate published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58871
  Scenario Outline: Publish WS  - GVDP - V6 Edited Brand published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58872
  Scenario Outline: Publish WS  - GVDP - V6 Added Brand published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @issue:GMIOMSUS-57220 @TEST:GMIOMSUS-58873
  Scenario Outline: Publish WS  - GVDP - V6 Edited Features published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58874
  Scenario Outline: Publish WS  - GVDP - V6 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58875
  Scenario Outline: Publish WS  - GVDP - V6 Added RPO - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58876
  Scenario Outline: Publish WS  - GVDP - V6 Edit Multiple RPOs 1 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58877
  Scenario Outline: Publish WS  - GVDP - V6 Added RPO - Single RPO - 2 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58878
  Scenario Outline: Publish WS  - GVDP - V6 Edit Category published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58879
  Scenario Outline: Publish WS  - GVDP - V6 New Category published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
