@CanadaOnly @TEST:GMIOMSUS-58832
Feature: Publish WS GVDP - V5 Vehicles Published through different tabs using Data Viewer in Canada FR

  Background:
    Given John has access to the vehicle api for country CA using V5

  @TEST:GMIOMSUS-58817
  Scenario Outline: Publish WS  - GVDP - V5 Search By Features Descriptions Added through Search Tab in Data Viewer CA FR
  ...
  @TEST:GMIOMSUS-58818
  Scenario Outline: Publish WS  - GVDP - V5 Search By RPO Descriptions using Single Edit in Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58819
  Scenario Outline: Publish WS  - GVDP - V5 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58820
  Scenario Outline: Publish WS  - GVDP - V5 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58821
  Scenario Outline: Publish WS  - GVDP - V5 Edited Nameplate published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58822
  Scenario Outline: Publish WS  - GVDP - V5 New Nameplate published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58823
  Scenario Outline: Publish WS  - GVDP - V5 Edited Brand published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58824
  Scenario Outline: Publish WS  - GVDP - V5 Added Brand published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @issue:GMIOMSUS-57220 @TEST:GMIOMSUS-58825
  Scenario Outline: Publish WS  - GVDP - V5 Edited Features published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58826
  Scenario Outline: Publish WS  - GVDP - V5 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58827
  Scenario Outline: Publish WS  - GVDP - V5 Added RPO - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58828
  Scenario Outline: Publish WS  - GVDP - V5 Edit Multiple RPOs 1 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58829
  Scenario Outline: Publish WS  - GVDP - V5 Added RPO - Single RPO - 2 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58830
  Scenario Outline: Publish WS  - GVDP - V5 Edit Category published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58831
  Scenario Outline: Publish WS  - GVDP - V5 New Category published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
