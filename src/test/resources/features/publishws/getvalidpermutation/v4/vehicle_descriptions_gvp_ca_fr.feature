@CanadaOnly @TEST:GMIOMSUS-58784
Feature: Publish WS GVDP - V4 Vehicles Published through different tabs using Data Viewer in Canada FR

  Background:
    Given John has access to the vehicle api for country CA using V4

  @TEST:GMIOMSUS-58769
  Scenario Outline: Publish WS  - GVDP - V4 Search By Features Descriptions Added through Search Tab in Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
  ...
  @TEST:GMIOMSUS-58770
  Scenario Outline: Publish WS  - GVDP - V4 Search By RPO Descriptions using Single Edit in Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58771
  Scenario Outline: Publish WS  - GVDP - V4 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58772
  Scenario Outline: Publish WS  - GVDP - V4 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58773
  Scenario Outline: Publish WS  - GVDP - V4 Edited Nameplate published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58774
  Scenario Outline: Publish WS  - GVDP - V4 New Nameplate published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58775
  Scenario Outline: Publish WS  - GVDP - V4 Edited Brand published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
    ...
    Examples:
      ...
      | +COUNTRY=CA+YEAR=2017+DIVISION=CADILLAC+BRAND=CTS SEDAN+RPOCODE=LF3 | +COUNTRY=CA+REGION=NATIONAL | DV-CA-SRCTST-AFT06A |             |               | 1000.0,1000.0   | Y                | 2017 CADILLAC CTS SedanIncDescFré  inclure LF3 |

  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58776
  Scenario Outline: Publish WS  - GVDP - V4 Added Brand published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @issue:GMIOMSUS-57220 @TEST:GMIOMSUS-58777
  Scenario Outline: Publish WS  - GVDP - V4 Edited Features published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58778
  Scenario Outline: Publish WS  - GVDP - V4 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58779
  Scenario Outline: Publish WS  - GVDP - V4 Added RPO - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58780
  Scenario Outline: Publish WS  - GVDP - V4 Edit Multiple RPOs 1 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58781
  Scenario Outline: Publish WS  - GVDP - V4 Added RPO - Single RPO - 2 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58782
  Scenario Outline: Publish WS  - GVDP - V4 Edit Category published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58783
  Scenario Outline: Publish WS  - GVDP - V4 New Category published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
