@CanadaOnly @TEST:GMIOMSUS-58976
Feature: Publish WS GVDP - V8 Vehicles Published through different tabs using Data Viewer in Canada FR

  Background:
    Given John has access to the vehicle api for country CA using V8

  @TEST:GMIOMSUS-58961
  Scenario Outline: Publish WS  - GVDP - V8 Search By Features Descriptions Added through Search Tab in Data Viewer CA FR
  ...
  @TEST:GMIOMSUS-58962
  Scenario Outline: Publish WS  - GVDP - V8 Search By RPO Descriptions using Single Edit in Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58963
  Scenario Outline: Publish WS  - GVDP - V8 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58964
  Scenario Outline: Publish WS  - GVDP - V8 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58965
  Scenario Outline: Publish WS  - GVDP - V8 Edited Nameplate published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58966
  Scenario Outline: Publish WS  - GVDP - V8 New Nameplate published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58967
  Scenario Outline: Publish WS  - GVDP - V8 Edited Brand published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58968
  Scenario Outline: Publish WS  - GVDP - V8 Added Brand published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @issue:GMIOMSUS-57220 @TEST:GMIOMSUS-58969
  Scenario Outline: Publish WS  - GVDP - V8 Edited Features published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58970
  Scenario Outline: Publish WS  - GVDP - V8 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58971
  Scenario Outline: Publish WS  - GVDP - V8 Added RPO - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58972
  Scenario Outline: Publish WS  - GVDP - V8 Edit Multiple RPOs 1 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58973
  Scenario Outline: Publish WS  - GVDP - V8 Added RPO - Single RPO - 2 published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58974
  Scenario Outline: Publish WS  - GVDP - V8 Edit Category published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58975
  Scenario Outline: Publish WS  - GVDP - V8 New Category published through Data Viewer CA FR
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using FR
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
