@CanadaOnly @TEST:GMIOMSUS-58960
Feature: Publish WS GVDP - V8 Vehicles Published through different tabs using Data Viewer in Canada EN

  Background:
    Given John has access to the vehicle api for country CA using V8

  @TEST:GMIOMSUS-58945
  Scenario Outline: Publish WS  - GVDP - V8 Search By Features Descriptions Added through Search Tab in Data Viewer CA EN
  ...
  @TEST:GMIOMSUS-58946
  Scenario Outline: Publish WS  - GVDP - V8 Search By RPO Descriptions using Single Edit in Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58947
  Scenario Outline: Publish WS  - GVDP - V8 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58948
  Scenario Outline: Publish WS  - GVDP - V8 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58949
  Scenario Outline: Publish WS  - GVDP - V8 Edited Nameplate published through Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58950
  Scenario Outline: Publish WS  - GVDP - V8 New Nameplate published through Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58951
  Scenario Outline: Publish WS  - GVDP - V8 Edited Brand published through Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58952
  Scenario Outline: Publish WS  - GVDP - V8 Added Brand published through Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @issue:GMIOMSUS-57220 @TEST:GMIOMSUS-58953
  Scenario Outline: Publish WS  - GVDP - V8 Edited Features published through Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58954
  Scenario Outline: Publish WS  - GVDP - V8 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58955
  Scenario Outline: Publish WS  - GVDP - V8 Added RPO - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58956
  Scenario Outline: Publish WS  - GVDP - V8 Edit Multiple RPOs 1 published through Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58957
  Scenario Outline: Publish WS  - GVDP - V8 Added RPO - Single RPO - 2 published through Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58958
  Scenario Outline: Publish WS  - GVDP - V8 Edit Category published through Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
  ...
  @TEST:GMIOMSUS-58959
  Scenario Outline: Publish WS  - GVDP - V8 New Category published through Data Viewer CA EN
    When the user has a GVD Permutation vehicle request to make to the api for the country CA using EN
      | Request FVD   | Request FGD   | Program ID   | Program GVD   | Incentive FVD   | Incentive Value   | Program Returned   | Header   |
      | <Request FVD> | <Request FGD> | <Program ID> | <Program GVD> | <Incentive FVD> | <Incentive Value> | <Program Returned> | <Header> |
    And the user makes a GVD Permutation vehicle request
