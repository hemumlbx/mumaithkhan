@CanadaOnly @TEST:GMIOMSUS-58640
Feature: Publish WS GVO - V6 Vehicles Published through different tabs using Data Viewer in Canada FR

  Background:
    Given John has access to the vehicle api for country CA using V6

  @TEST:GMIOMSUS-58625
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Search By Features Descriptions Added through Search Tab in Data Viewer CA FR
  ...
  @TEST:GMIOMSUS-58626
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Search By RPO Descriptions using Single Edit in Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58627
  Scenario Outline: Scenario Outline: Publish WS  - Get Valid Offer - V6 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58628
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58629
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Edited Nameplate published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58630
  Scenario Outline: Publish WS  - Get Valid Offer - V6 New Nameplate published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58631
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Edited Brand published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58632
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Added Brand published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58633
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Edited Features published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58634
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58635
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Added RPO - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58636
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Edit Multiple RPOs 1 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58637
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Added RPO - Single RPO - 2 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58638
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Edit Category published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58639
  Scenario Outline: Publish WS  - Get Valid Offer - V6 New Category published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
