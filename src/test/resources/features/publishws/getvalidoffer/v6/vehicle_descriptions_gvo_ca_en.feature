@CanadaOnly @TEST:GMIOMSUS-58624
Feature: Publish WS GVO - V6 Vehicles Published through different tabs using Data Viewer in Canada EN

  Background:
    Given John has access to the vehicle api for country CA using V6

  @TEST:GMIOMSUS-58609
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Search By Features Descriptions Added through Search Tab in Data Viewer CA EN
  ...
  @TEST:GMIOMSUS-58610
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Search By RPO Descriptions using Single Edit in Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58611
  Scenario Outline: Scenario Outline: Publish WS  - Get Valid Offer - V6 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58612
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58613
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Edited Nameplate published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58614
  Scenario Outline: Publish WS  - Get Valid Offer - V6 New Nameplate published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58615
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Edited Brand published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58616
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Added Brand published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58617
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Edited Features published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58618
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58619
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Added RPO - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58620
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Edit Multiple RPOs 1 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58621
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Added RPO - Single RPO - 2 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58622
  Scenario Outline: Publish WS  - Get Valid Offer - V6 Edit Category published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58623
  Scenario Outline: Publish WS  - Get Valid Offer - V6 New Category published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
