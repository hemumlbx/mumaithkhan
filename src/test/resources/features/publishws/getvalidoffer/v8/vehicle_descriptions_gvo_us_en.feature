@USOnly @TEST:GMIOMSUS-58752
Feature: Publish WS GVO - V8 Vehicles Published through different tabs using Data Viewer in US EN

  Background:
    Given John has access to the vehicle api for country US using V8

  @TEST:GMIOMSUS-58737
  Scenario Outline: Publish WS  - Get Valid Offer - V8 Search By Features Descriptions Added through Search Tab in Data Viewer US EN
  ...
  @TEST:GMIOMSUS-58738
  Scenario Outline: Publish WS  - Get Valid Offer - V8 Search By RPO Descriptions using Single Edit in Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58739
  Scenario Outline: Scenario Outline: Publish WS  - Get Valid Offer - V8 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58740
  Scenario Outline: Publish WS  - Get Valid Offer - V8 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58741
  Scenario Outline: Publish WS  - Get Valid Offer - V8 Edited Nameplate published through Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58742
  Scenario Outline: Publish WS  - Get Valid Offer - V8 New Nameplate published through Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58743
  Scenario Outline: Publish WS  - Get Valid Offer - V8 Edited Brand published through Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58744
  Scenario Outline: Publish WS  - Get Valid Offer - V8 Added Brand published through Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58745
  Scenario Outline: Publish WS  - Get Valid Offer - V8 Edited Features published through Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58746
  Scenario Outline: Publish WS  - Get Valid Offer - V8 Edit RPO Tab - Single RPO - 1 published through Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58747
  Scenario Outline: Publish WS  - Get Valid Offer - V8 Added RPO - Single RPO - 1 published through Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58748
  Scenario Outline: Publish WS  - Get Valid Offer - V8 Edit Multiple RPOs 1 published through Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58749
  Scenario Outline: Publish WS  - Get Valid Offer - V8 Added RPO - Single RPO - 2 published through Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58750
  Scenario Outline: Publish WS  - Get Valid Offer - V8 Edit Category published through Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58751
  Scenario Outline: Publish WS  - Get Valid Offer - V8 New Category published through Data Viewer US EN
    When the user has a GVO vehicle request to the api for the country US using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
