@CanadaOnly @TEST:GMIOMSUS-58528
Feature: Publish WS GVO - V4 Vehicles Published through different tabs using Data Viewer in Canada EN

  Background:
    Given John has access to the vehicle api for country CA using V4

  @TEST:GMIOMSUS-58513
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Search By Features Descriptions Added through Search Tab in Data Viewer CA EN
  ...
  @TEST:GMIOMSUS-58514
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Search By RPO Descriptions using Single Edit in Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58515
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58516
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58517
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Edited Nameplate published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58518
  Scenario Outline: Publish WS  - Get Valid Offer - V4 New Nameplate published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58519
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Edited Brand published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58520
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Added Brand published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58521
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Edited Features published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58522
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58523
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Added RPO - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58524
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Edit Multiple RPOs 1 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58525
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Added RPO - Single RPO - 2 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58526
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Edit Category published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58527
  Scenario Outline: Publish WS  - Get Valid Offer - V4 New Category published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
