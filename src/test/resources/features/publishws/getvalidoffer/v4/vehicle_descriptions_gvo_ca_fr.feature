@CanadaOnly @TEST:GMIOMSUS-58544
Feature: Publish WS GVO - V4 Vehicles Published through different tabs using Data Viewer in Canada FR

  Background:
    Given John has access to the vehicle api for country CA using V4

  @TEST:GMIOMSUS-58529
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Search By Features Descriptions Added through Search Tab in Data Viewer CA FR
  ...
  @TEST:GMIOMSUS-58530
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Search By RPO Descriptions using Single Edit in Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58531
  Scenario Outline: Scenario Outline: Publish WS  - Get Valid Offer - V4 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58532
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58533
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Edited Nameplate published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58534
  Scenario Outline: Publish WS  - Get Valid Offer - V4 New Nameplate published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58535
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Edited Brand published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58536
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Added Brand published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58537
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Edited Features published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58538
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58539
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Added RPO - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58540
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Edit Multiple RPOs 1 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58541
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Added RPO - Single RPO - 2 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58542
  Scenario Outline: Publish WS  - Get Valid Offer - V4 Edit Category published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58543
  Scenario Outline: Publish WS  - Get Valid Offer - V4 New Category published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
