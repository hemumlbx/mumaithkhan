@CanadaOnly @TEST:GMIOMSUS-58672
Feature: Publish WS GVO - V7 Vehicles Published through different tabs using Data Viewer in Canada EN

  Background:
    Given John has access to the vehicle api for country CA using V7

  @TEST:GMIOMSUS-58657
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Search By Features Descriptions Added through Search Tab in Data Viewer CA EN
  ...
  @TEST:GMIOMSUS-58658
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Search By RPO Descriptions using Single Edit in Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58659
  Scenario Outline: Scenario Outline: Publish WS  - Get Valid Offer - V7 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58660
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58661
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Edited Nameplate published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58662
  Scenario Outline: Publish WS  - Get Valid Offer - V7 New Nameplate published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58663
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Edited Brand published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58664
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Added Brand published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58665
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Edited Features published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58666
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58667
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Added RPO - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58668
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Edit Multiple RPOs 1 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58669
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Added RPO - Single RPO - 2 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58670
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Edit Category published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58671
  Scenario Outline: Publish WS  - Get Valid Offer - V7 New Category published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
