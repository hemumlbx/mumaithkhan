@CanadaOnly @TEST:GMIOMSUS-58688
Feature: Publish WS GVO - V7 Vehicles Published through different tabs using Data Viewer in Canada FR

  Background:
    Given John has access to the vehicle api for country CA using V7

  @TEST:GMIOMSUS-58673
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Search By Features Descriptions Added through Search Tab in Data Viewer CA FR
  ...
  @TEST:GMIOMSUS-58674
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Search By RPO Descriptions using Single Edit in Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58675
  Scenario Outline: Scenario Outline: Publish WS  - Get Valid Offer - V7 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58676
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58677
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Edited Nameplate published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58678
  Scenario Outline: Publish WS  - Get Valid Offer - V7 New Nameplate published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58679
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Edited Brand published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58680
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Added Brand published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58681
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Edited Features published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58682
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58683
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Added RPO - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58684
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Edit Multiple RPOs 1 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58685
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Added RPO - Single RPO - 2 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58686
  Scenario Outline: Publish WS  - Get Valid Offer - V7 Edit Category published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58687
  Scenario Outline: Publish WS  - Get Valid Offer - V7 New Category published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
