@CanadaOnly @TEST:GMIOMSUS-58592
Feature: Publish WS GVO - V5 Vehicles Published through different tabs using Data Viewer in Canada FR

  Background:
    Given John has access to the vehicle api for country CA using V5

  @TEST:GMIOMSUS-58577
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Search By Features Descriptions Added through Search Tab in Data Viewer CA FR
  ...
  @TEST:GMIOMSUS-58578
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Search By RPO Descriptions using Single Edit in Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58579
  Scenario Outline: Scenario Outline: Publish WS  - Get Valid Offer - V5 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58580
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58581
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Edited Nameplate published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58582
  Scenario Outline: Publish WS  - Get Valid Offer - V5 New Nameplate published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58583
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Edited Brand published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58584
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Added Brand published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58585
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Edited Features published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58586
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58587
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Added RPO - Single RPO - 1 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58588
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Edit Multiple RPOs 1 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58589
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Added RPO - Single RPO - 2 published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58590
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Edit Category published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58591
  Scenario Outline: Publish WS  - Get Valid Offer - V5 New Category published through Data Viewer CA FR
    When the user has a GVO vehicle request to the api for the country CA using FR
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
