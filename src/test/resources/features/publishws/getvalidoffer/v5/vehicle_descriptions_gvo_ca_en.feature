@CanadaOnly @TEST:GMIOMSUS-58576
Feature: Publish WS GVO - V5 Vehicles Published through different tabs using Data Viewer in Canada EN

  Background:
    Given John has access to the vehicle api for country CA using V5

  @TEST:GMIOMSUS-58561
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Search By Features Descriptions Added through Search Tab in Data Viewer CA EN
  ...
  @TEST:GMIOMSUS-58562
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Search By RPO Descriptions using Single Edit in Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58563
  Scenario Outline: Scenario Outline: Publish WS  - Get Valid Offer - V5 Search By RPO Descriptions using Multiple Edits 1 in Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58564
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Search By RPO Descriptions using Multiple Edits 2 in Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58565
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Edited Nameplate published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58566
  Scenario Outline: Publish WS  - Get Valid Offer - V5 New Nameplate published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58567
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Edited Brand published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @issue:GMIOMSUS-53727 @TEST:GMIOMSUS-58568
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Added Brand published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58569
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Edited Features published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58570
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Edit RPO Tab - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58571
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Added RPO - Single RPO - 1 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58572
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Edit Multiple RPOs 1 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58573
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Added RPO - Single RPO - 2 published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58574
  Scenario Outline: Publish WS  - Get Valid Offer - V5 Edit Category published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
  ...
  @TEST:GMIOMSUS-58575
  Scenario Outline: Publish WS  - Get Valid Offer - V5 New Category published through Data Viewer CA EN
    When the user has a GVO vehicle request to the api for the country CA using EN
      | Request FVD   | Request FGD   |
      | <Request FVD> | <Request FGD> |
    And the user makes a request for GVO vehicle
